...
translation_function_names = ['dict_cc', 'pons', 'google']
...
show_in_browser = 'google-chrome-stable "http://www.linguee.com/english-russian/search?source=english&query=${word}"'
...
split_long_lines_in_popup_B = False
...
# he_fonts = ['NotoSansMono Nerd Font']
