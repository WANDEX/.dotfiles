...
local options2 = {
  {keys = {'2', 'w'}, option = {'framelen',   100, 10, 8000,  500,  500 } },
  {keys = {'3', 'f'}, option = {'gausssize',    1,  3,  301,   31,   31 } },
  {keys = {'4', 'p'}, option = {'peak',      0.01,  0,    1, 0.95, 0.95 } },
  {keys = {'5', 'g'}, option = {'maxgain',      1,  1,  100,   10,   10 } },
  {keys = {'6', 'j'}, option = {'targetrms', 0.01,  0,    1,    0,    0 } },
  {keys = {'7', 'l'}, option = {'coupling',     1,  0,    1,    1,    1 } },
  {keys = {'8', 'u'}, option = {'correctdc',    1,  0,    1,    0,    0 } },
  {keys = {'9', 'y'}, option = {'compress',     1,  0,   30,    0,    0 } },
}

local options = {
  {keys = {'2', 'w'}, option = {'framelen',   100, 10, 8000,  150,  150 } },
  {keys = {'3', 'f'}, option = {'gausssize',    1,  3,  301,   15,   15 } },
  {keys = {'4', 'p'}, option = {'peak',      0.01,  0,    1, 0.71, 0.71 } },
  {keys = {'5', 'g'}, option = {'maxgain',      1,  1,  100,  100,  100 } },
  {keys = {'6', 'j'}, option = {'targetrms',  0.1,  0,    1,    1,    1 } },
  {keys = {'7', 'l'}, option = {'coupling',     1,  0,    1,    1,    1 } },
  {keys = {'8', 'u'}, option = {'correctdc',    1,  0,    1,    1,    1 } },
  {keys = {'9', 'y'}, option = {'compress',     1,  0,   30,   12,   12 } },
}
